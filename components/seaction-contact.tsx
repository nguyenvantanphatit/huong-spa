        ...
        >
            <div className="flex flex-col md:flex-row items-center max-w-[1200px] container gap-5 md:gap-[30px] px-6 md:py-10 mt-4 md:mt-6 mb-[48px] md:mb-5 mx-auto">
                ...
                >
                    ...
                    <h2 className="block md:hidden text-xl font-normal text-[#CC424E] mb-3 text-center md:text-start">
                        Đặt lịch ngay hôm nay để
                        <br />
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 items-center">
                        ...
                        >
                            <Link
                                href="/menu"
                                className="group relative inline-flex w-[220px] items-center justify-center gap-2 py-3 md:py-4 px-[50px] md:px-10 font-semibold rounded-full whitespace-nowrap border-2 border-[#CC424E] text-[#CC424E] overflow-hidden transition-all duration-300
              ...
              hover:before:w-full hover:boder-transparent hover:text-white"
                            >
                                <svg
                                    width="24"
                                    height="24"
                        ...
                        >
                            ...
                            >
                                <svg
                                    ...
                                    fill="none"
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="relative z-10 w-6 h-6 fill-current transition-colors duration-300 group-hover:fill-white"
                                >
                                    <path
                                        fillRule="evenodd"
                                        clipRule="evenodd"
