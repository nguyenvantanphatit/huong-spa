...
export default async function AboutPage() {
  ...
  return (
    <>
      ...
      />
      <div className="flex min-h-[calc(100vh-4rem)] flex-col gap-14">
        <Container>
          ...
          <AnimatedAboutSection>
            <div className="flex flex-col justify-center gap-10 text-center">
              <h6 className="text-xl md:text-[38px] font-medium text-[#CC424E] mb-8 md:mt-16 pt-8 mt-4 leading-7 uppercase">
                không chỉ là spa
                <br />
                <span className="block md:mt-6">Mà là một hành trình</span>
              </h6>
              <div className="flex flex-col md:flex-row md:gap-[72px] text-[#2E333D] font-medium text-sm md:text-xl max-w-[1284px] mx-auto text-start md:text-center">
